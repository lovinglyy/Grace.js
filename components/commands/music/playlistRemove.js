...
module.exports = {
	...
	*/
	cmd: async function( msg, argSeparator, redisClient  ) {
		if ( !redisClient ) return;

		let removeIndex = ~~( msg.content.substring( argSeparator ) );
		...
		let song = libs.music.findSongByIndex(userPlaylist, removeIndex);
